...
class problem8 {
    ...
    public static long largestProduct(String subsequence) {
        ...
        for(int subsequenceCounter = 0; subsequenceCounter < subsequence.length() - 12; subsequenceCounter++) {
            for(int till13 = 0; till13 < 13; till13++) {
                curr *= (long) subsequence.charAt(subsequenceCounter + till13) - 48;
            }
